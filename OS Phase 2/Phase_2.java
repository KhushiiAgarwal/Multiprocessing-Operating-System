...
//                System.out.println(buffer);
                    ...
                    sb.append('\n');
                    Files.write(Paths.get("/Users/jinayjain/Documents/OS Phase 2/out.txt"), String.valueOf(sb).getBytes(), StandardOpenOption.APPEND);
    ...
    public void terminate(int EM){
        ...
        try{
            switch (EM){
                ...
                case 0:
                    Files.write(Paths.get("/Users/jinayjain/Documents/OS Phase 2/out.txt"), (jobDetails+interrupts+cpuDetails+"\nTerminated Sucessfully\n\n").getBytes(), StandardOpenOption.APPEND);
                    break;
                case 1:
                    Files.write(Paths.get("/Users/jinayjain/Documents/OS Phase 2/out.txt"), (jobDetails+interrupts+cpuDetails+"\nOut of Data\n\n").getBytes(), StandardOpenOption.APPEND);
                    break;
    ...
    static {
        try {
            file = new java.io.File("/Users/jinayjain/Documents/OS Phase 2/input.txt");
